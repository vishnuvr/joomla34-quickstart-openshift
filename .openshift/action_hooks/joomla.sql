...
--
-- Host: localhost
-- Generation Time: Feb 24, 2013 at 01:16 AM
...
--
-- Database: `joomla3.0.3`
--

-- --------------------------------------------------------

--
-- Table structure for table `k709c_assets`
--

CREATE TABLE IF NOT EXISTS `k709c_assets` (
...
--
-- Dumping data for table `k709c_assets`
--

INSERT INTO `k709c_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
--
-- Table structure for table `k709c_associations`
--

CREATE TABLE IF NOT EXISTS `k709c_associations` (
...
--
-- Dumping data for table `k709c_associations`
--
...
--
-- Table structure for table `k709c_banners`
--

CREATE TABLE IF NOT EXISTS `k709c_banners` (
...
--
-- Dumping data for table `k709c_banners`
--
...
--
-- Table structure for table `k709c_banner_clients`
--

CREATE TABLE IF NOT EXISTS `k709c_banner_clients` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Dumping data for table `k709c_banner_clients`
--
...
--
-- Table structure for table `k709c_banner_tracks`
--

CREATE TABLE IF NOT EXISTS `k709c_banner_tracks` (
...
--
-- Dumping data for table `k709c_banner_tracks`
--
...
--
-- Table structure for table `k709c_categories`
--

CREATE TABLE IF NOT EXISTS `k709c_categories` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `k709c_categories`
--

INSERT INTO `k709c_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`, `version`) VALUES
(1, 0, 0, 0, 13, 0, '', 'system', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{}', '', '', '', 520, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(2, 27, 1, 1, 2, 1, 'uncategorised', 'com_content', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":""}', '', '', '{"page_title":"","author":"","robots":""}', 520, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(3, 28, 1, 3, 4, 1, 'uncategorised', 'com_banners', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":"","foobar":""}', '', '', '{"page_title":"","author":"","robots":""}', 520, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(4, 29, 1, 5, 6, 1, 'uncategorised', 'com_contact', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":""}', '', '', '{"page_title":"","author":"","robots":""}', 520, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(5, 30, 1, 7, 8, 1, 'uncategorised', 'com_newsfeeds', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":""}', '', '', '{"page_title":"","author":"","robots":""}', 520, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(6, 31, 1, 9, 10, 1, 'uncategorised', 'com_weblinks', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":""}', '', '', '{"page_title":"","author":"","robots":""}', 520, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(7, 32, 1, 11, 12, 1, 'uncategorised', 'com_users', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":""}', '', '', '{"page_title":"","author":"","robots":""}', 520, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1);

-- --------------------------------------------------------

--
-- Table structure for table `k709c_contact_details`
--

CREATE TABLE IF NOT EXISTS `k709c_contact_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
  `alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
...
--
-- Dumping data for table `k709c_contact_details`
--
...
--
-- Table structure for table `k709c_content`
--

CREATE TABLE IF NOT EXISTS `k709c_content` (
...
--
-- Dumping data for table `k709c_content_frontpage`
--
...
--
-- Table structure for table `k709c_content_rating`
--

CREATE TABLE IF NOT EXISTS `k709c_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `k709c_content_rating`
--
...
--
-- Table structure for table `k709c_core_log_searches`
--

CREATE TABLE IF NOT EXISTS `k709c_core_log_searches` (
  `search_term` varchar(128) NOT NULL DEFAULT '',
  `hits` int(10) unsigned NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `k709c_core_log_searches`
--
...
--
-- Table structure for table `k709c_extensions`
--

CREATE TABLE IF NOT EXISTS `k709c_extensions` (
...
--
-- Dumping data for table `k709c_extensions`
--

INSERT INTO `k709c_extensions` (`extension_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
--
-- Table structure for table `k709c_finder_filters`
--

CREATE TABLE IF NOT EXISTS `k709c_finder_filters` (
...
--
-- Dumping data for table `k709c_finder_filters`
--
...
--
-- Table structure for table `k709c_finder_links`
--

CREATE TABLE IF NOT EXISTS `k709c_finder_links` (
...
--
-- Dumping data for table `k709c_finder_links`
--
...
--
-- Table structure for table `k709c_finder_links_terms0`
--

CREATE TABLE IF NOT EXISTS `k709c_finder_links_terms0` (
...
--
-- Dumping data for table `k709c_finder_links_terms0`
--
...
--
-- Table structure for table `k709c_finder_links_terms1`
--

CREATE TABLE IF NOT EXISTS `k709c_finder_links_terms1` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Dumping data for table `k709c_finder_links_terms1`
--
...
--
-- Table structure for table `k709c_finder_links_terms2`
--

CREATE TABLE IF NOT EXISTS `k709c_finder_links_terms2` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Dumping data for table `k709c_finder_links_terms2`
--
...
--
-- Table structure for table `k709c_finder_links_terms3`
--

CREATE TABLE IF NOT EXISTS `k709c_finder_links_terms3` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Dumping data for table `k709c_finder_links_terms3`
--
...
--
-- Table structure for table `k709c_finder_links_terms4`
--

CREATE TABLE IF NOT EXISTS `k709c_finder_links_terms4` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Dumping data for table `k709c_finder_links_terms4`
--
...
--
-- Table structure for table `k709c_finder_links_terms5`
--

CREATE TABLE IF NOT EXISTS `k709c_finder_links_terms5` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Dumping data for table `k709c_finder_links_terms5`
--
...
--
-- Table structure for table `k709c_finder_links_terms6`
--

CREATE TABLE IF NOT EXISTS `k709c_finder_links_terms6` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Dumping data for table `k709c_finder_links_terms6`
--
...
--
-- Table structure for table `k709c_finder_links_terms7`
--

CREATE TABLE IF NOT EXISTS `k709c_finder_links_terms7` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Dumping data for table `k709c_finder_links_terms7`
--
...
--
-- Table structure for table `k709c_finder_links_terms8`
--

CREATE TABLE IF NOT EXISTS `k709c_finder_links_terms8` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Dumping data for table `k709c_finder_links_terms8`
--
...
--
-- Table structure for table `k709c_finder_links_terms9`
--

CREATE TABLE IF NOT EXISTS `k709c_finder_links_terms9` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Dumping data for table `k709c_finder_links_terms9`
--
...
--
-- Table structure for table `k709c_finder_links_termsa`
--

CREATE TABLE IF NOT EXISTS `k709c_finder_links_termsa` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Dumping data for table `k709c_finder_links_termsa`
--
...
--
-- Table structure for table `k709c_finder_links_termsb`
--

CREATE TABLE IF NOT EXISTS `k709c_finder_links_termsb` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Dumping data for table `k709c_finder_links_termsb`
--
...
--
-- Table structure for table `k709c_finder_links_termsc`
--

CREATE TABLE IF NOT EXISTS `k709c_finder_links_termsc` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Dumping data for table `k709c_finder_links_termsc`
--
...
--
-- Table structure for table `k709c_finder_links_termsd`
--

CREATE TABLE IF NOT EXISTS `k709c_finder_links_termsd` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Dumping data for table `k709c_finder_links_termsd`
--
...
--
-- Table structure for table `k709c_finder_links_termse`
--

CREATE TABLE IF NOT EXISTS `k709c_finder_links_termse` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Dumping data for table `k709c_finder_links_termse`
--
...
--
-- Table structure for table `k709c_finder_links_termsf`
--

CREATE TABLE IF NOT EXISTS `k709c_finder_links_termsf` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Dumping data for table `k709c_finder_links_termsf`
--
...
--
-- Table structure for table `k709c_finder_taxonomy`
--

CREATE TABLE IF NOT EXISTS `k709c_finder_taxonomy` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
--
-- Dumping data for table `k709c_finder_taxonomy`
--

INSERT INTO `k709c_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `k709c_finder_taxonomy_map`
--

CREATE TABLE IF NOT EXISTS `k709c_finder_taxonomy_map` (
  `link_id` int(10) unsigned NOT NULL,
...
--
-- Dumping data for table `k709c_finder_taxonomy_map`
--
...
--
-- Table structure for table `k709c_finder_terms`
--

CREATE TABLE IF NOT EXISTS `k709c_finder_terms` (
...
--
-- Dumping data for table `k709c_finder_terms`
--
...
--
-- Table structure for table `k709c_finder_terms_common`
--

CREATE TABLE IF NOT EXISTS `k709c_finder_terms_common` (
  `term` varchar(75) NOT NULL,
...
--
-- Dumping data for table `k709c_finder_terms_common`
--

INSERT INTO `k709c_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Table structure for table `k709c_finder_tokens`
--

CREATE TABLE IF NOT EXISTS `k709c_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `phrase` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `k709c_finder_tokens`
--
...
--
-- Table structure for table `k709c_finder_tokens_aggregate`
--

CREATE TABLE IF NOT EXISTS `k709c_finder_tokens_aggregate` (
  `term_id` int(10) unsigned NOT NULL,
...
--
-- Dumping data for table `k709c_finder_tokens_aggregate`
--
...
--
-- Table structure for table `k709c_finder_types`
--

CREATE TABLE IF NOT EXISTS `k709c_finder_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `k709c_finder_types`
--
...
--
-- Table structure for table `k709c_languages`
--

CREATE TABLE IF NOT EXISTS `k709c_languages` (
...
--
-- Dumping data for table `k709c_languages`
--

INSERT INTO `k709c_languages` (`lang_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
(1, 'en-GB', 'English (UK)', 'English (UK)', 'en', 'en', '', '', '', '', 1, 0, 1);

-- --------------------------------------------------------

--
-- Table structure for table `k709c_menu`
--

CREATE TABLE IF NOT EXISTS `k709c_menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `k709c_menu`
--

INSERT INTO `k709c_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
--
-- Table structure for table `k709c_menu_types`
--

CREATE TABLE IF NOT EXISTS `k709c_menu_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `k709c_menu_types`
--

INSERT INTO `k709c_menu_types` (`id`, `menutype`, `title`, `description`) VALUES
...
--
-- Table structure for table `k709c_messages`
--

CREATE TABLE IF NOT EXISTS `k709c_messages` (
...
--
-- Dumping data for table `k709c_messages`
--
...
--
-- Table structure for table `k709c_messages_cfg`
--

CREATE TABLE IF NOT EXISTS `k709c_messages_cfg` (
...
--
-- Dumping data for table `k709c_messages_cfg`
--
...
--
-- Table structure for table `k709c_modules`
--

CREATE TABLE IF NOT EXISTS `k709c_modules` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `k709c_modules`
--

INSERT INTO `k709c_modules` (`id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
...
--
-- Table structure for table `k709c_modules_menu`
--

CREATE TABLE IF NOT EXISTS `k709c_modules_menu` (
...
--
-- Dumping data for table `k709c_modules_menu`
--

INSERT INTO `k709c_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Table structure for table `k709c_newsfeeds`
--

CREATE TABLE IF NOT EXISTS `k709c_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `k709c_newsfeeds`
--
...
--
-- Table structure for table `k709c_overrider`
--

CREATE TABLE IF NOT EXISTS `k709c_overrider` (
...
--
-- Dumping data for table `k709c_overrider`
--
...
--
-- Table structure for table `k709c_redirect_links`
--

CREATE TABLE IF NOT EXISTS `k709c_redirect_links` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `k709c_redirect_links`
--
...
--
-- Table structure for table `k709c_schemas`
--

CREATE TABLE IF NOT EXISTS `k709c_schemas` (
...
--
-- Dumping data for table `k709c_schemas`
--

INSERT INTO `k709c_schemas` (`extension_id`, `version_id`) VALUES
(700, '3.0.3');

-- --------------------------------------------------------

--
-- Table structure for table `k709c_session`
--

CREATE TABLE IF NOT EXISTS `k709c_session` (
...
--
-- Dumping data for table `k709c_session`
--

INSERT INTO `k709c_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`) VALUES
('tfd680tmq3ep57fodg0alecpg0', 1, 1, '1361648515', '__default|a:8:{s:15:"session.counter";i:1;s:19:"session.timer.start";i:1361648515;s:18:"session.timer.last";i:1361648515;s:17:"session.timer.now";i:1361648515;s:22:"session.client.browser";s:101:"Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.17 (KHTML, like Gecko) Chrome/24.0.1312.57 Safari/537.17";s:8:"registry";O:9:"JRegistry":1:{s:7:"\\0\\0\\0data";O:8:"stdClass":0:{}}s:4:"user";O:5:"JUser":24:{s:9:"\\0\\0\\0isRoot";N;s:2:"id";i:0;s:4:"name";N;s:8:"username";N;s:5:"email";N;s:8:"password";N;s:14:"password_clear";s:0:"";s:5:"block";N;s:9:"sendEmail";i:0;s:12:"registerDate";N;s:13:"lastvisitDate";N;s:10:"activation";N;s:6:"params";N;s:6:"groups";a:1:{i:0;s:1:"9";}s:5:"guest";i:1;s:13:"lastResetTime";N;s:10:"resetCount";N;s:10:"\\0\\0\\0_params";O:9:"JRegistry":1:{s:7:"\\0\\0\\0data";O:8:"stdClass":0:{}}s:14:"\\0\\0\\0_authGroups";N;s:14:"\\0\\0\\0_authLevels";a:3:{i:0;i:1;i:1;i:1;i:2;i:5;}s:15:"\\0\\0\\0_authActions";N;s:12:"\\0\\0\\0_errorMsg";N;s:10:"\\0\\0\\0_errors";a:0:{}s:3:"aid";i:0;}s:13:"session.token";s:32:"62e774b0abd088f53b52b1e34f956ffe";}', 0, '');

-- --------------------------------------------------------

--
-- Table structure for table `k709c_template_styles`
--

CREATE TABLE IF NOT EXISTS `k709c_template_styles` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `k709c_template_styles`
--

INSERT INTO `k709c_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
...
--
-- Table structure for table `k709c_updates`
--

CREATE TABLE IF NOT EXISTS `k709c_updates` (
...
--
-- Dumping data for table `k709c_updates`
--

INSERT INTO `k709c_updates` (`update_id`, `update_site_id`, `extension_id`, `name`, `description`, `element`, `type`, `folder`, `client_id`, `version`, `data`, `detailsurl`, `infourl`) VALUES
...
(9, 3, 0, 'Arabic Unitag', '', 'pkg_ar-AA', 'package', '', 0, '3.0.3.1', '', 'http://update.joomla.org/language/details3/ar-AA_details.xml', ''),
(10, 3, 0, 'Belarusian', '', 'pkg_be-BY', 'package', '', 0, '3.0.2.1', '', 'http://update.joomla.org/language/details3/be-BY_details.xml', ''),
(11, 3, 0, 'Bulgarian', '', 'pkg_bg-BG', 'package', '', 0, '3.0.0.1', '', 'http://update.joomla.org/language/details3/bg-BG_details.xml', ''),
...
(29, 3, 0, 'Russian', '', 'pkg_ru-RU', 'package', '', 0, '3.0.2.1', '', 'http://update.joomla.org/language/details3/ru-RU_details.xml', ''),
...
(35, 3, 0, 'Turkish', '', 'pkg_tr-TR', 'package', '', 0, '3.0.3.1', '', 'http://update.joomla.org/language/details3/tr-TR_details.xml', ''),
...
(41, 3, 0, 'Bosnian', '', 'pkg_bs-BA', 'package', '', 0, '3.0.2.1', '', 'http://update.joomla.org/language/details3/bs-BA_details.xml', ''),
...
--
-- Table structure for table `k709c_update_sites`
--

CREATE TABLE IF NOT EXISTS `k709c_update_sites` (
...
--
-- Dumping data for table `k709c_update_sites`
--

INSERT INTO `k709c_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`) VALUES
(1, 'Joomla Core', 'collection', 'http://update.joomla.org/core/list.xml', 1, 1361648493),
(2, 'Joomla Extension Directory', 'collection', 'http://update.joomla.org/jed/list.xml', 1, 1361648493),
(3, 'Accredited Joomla! Translations', 'collection', 'http://update.joomla.org/language/translationlist_3.xml', 1, 1361648493);

-- --------------------------------------------------------

--
-- Table structure for table `k709c_update_sites_extensions`
--

CREATE TABLE IF NOT EXISTS `k709c_update_sites_extensions` (
...
--
-- Dumping data for table `k709c_update_sites_extensions`
--

INSERT INTO `k709c_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 700),
(3, 600);
...
--
-- Table structure for table `k709c_usergroups`
--

CREATE TABLE IF NOT EXISTS `k709c_usergroups` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
...
--
-- Dumping data for table `k709c_usergroups`
--

INSERT INTO `k709c_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 18, 'Public'),
(2, 1, 8, 15, 'Registered'),
(3, 2, 9, 14, 'Author'),
(4, 3, 10, 13, 'Editor'),
...
--
-- Table structure for table `k709c_users`
--

CREATE TABLE IF NOT EXISTS `k709c_users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Dumping data for table `k709c_users`
--

INSERT INTO `k709c_users` (`id`, `name`, `username`, `email`, `password`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`) VALUES
(520, 'Super User', 'admin', 'admin@admin.com', '6d895d70ea15c976549062413ab72e82:EFh5amfHwKN8cifEFS6BGgDm3MFrYTOE', 0, 1, '2013-02-23 19:40:06', '2013-02-23 19:41:55', '0', '', '0000-00-00 00:00:00', 0);

-- --------------------------------------------------------

--
-- Table structure for table `k709c_user_notes`
--

CREATE TABLE IF NOT EXISTS `k709c_user_notes` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `catid` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `k709c_user_notes`
--
...
--
-- Table structure for table `k709c_user_profiles`
--

CREATE TABLE IF NOT EXISTS `k709c_user_profiles` (
...
--
-- Dumping data for table `k709c_user_profiles`
--
...
--
-- Table structure for table `k709c_user_usergroup_map`
--

CREATE TABLE IF NOT EXISTS `k709c_user_usergroup_map` (
...
--
-- Dumping data for table `k709c_user_usergroup_map`
--

INSERT INTO `k709c_user_usergroup_map` (`user_id`, `group_id`) VALUES
(520, 8);

-- --------------------------------------------------------

--
-- Table structure for table `k709c_viewlevels`
--

CREATE TABLE IF NOT EXISTS `k709c_viewlevels` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `title` varchar(100) NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) NOT NULL COMMENT 'JSON encoded access control.',
...
--
-- Dumping data for table `k709c_viewlevels`
--

INSERT INTO `k709c_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
...
--
-- Table structure for table `k709c_weblinks`
--

CREATE TABLE IF NOT EXISTS `k709c_weblinks` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `catid` int(11) NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `k709c_weblinks`
--
